...
### Q1: Do I need to change code when upgrading from < 1.5.0 / < 2.4.0?
...
**No.** It must return synchronously. Async hooks would introduce concurrency complexity (high-volume logs + upload ordering). For async work, do it inside `upload`.
